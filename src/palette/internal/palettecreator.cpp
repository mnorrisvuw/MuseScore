...
PalettePtr PaletteCreator::newTempoPalette(bool defaultPalette)
{
    ...
    static const TempoPattern tps[] = {
        ...
        TempoPattern("Grave",            "Grave",             35.0 / 60.0, false, true, true, false, false),
        TempoPattern("Largo",            "Largo",             50.0 / 60.0, false, true, true, false, false),
        TempoPattern("Lento",            "Lento",             52.5 / 60.0, false, true, true, false, false),
        TempoPattern("Larghetto",        "Larghetto",         63.0 / 60.0, false, true, true, false, true),
        TempoPattern("Adagio",           "Adagio",            71.0 / 60.0, false, true, true, false, false),
        TempoPattern("Andante",          "Andante",           92.0 / 60.0, false, true, true, false, false),
        TempoPattern("Andantino",        "Andantino",         94.0 / 60.0, false, true, true, false, true),
        TempoPattern("Moderato",         "Moderato",         114.0 / 60.0, false, true, true, false, false),
        TempoPattern("Allegretto",       "Allegretto",       116.0 / 60.0, false, true, true, false, false),
        TempoPattern("Allegro",          "Allegro",          144.0 / 60.0, false, true, true, false, false),
        TempoPattern("Vivace",           "Vivace",           172.0 / 60.0, false, true, true, false, false),
        TempoPattern("Presto",           "Presto",           187.0 / 60.0, false, true, true, false, false),
        TempoPattern("Prestissimo",      "Prestissimo",      200.0 / 60.0, false, true, true, false, true),
